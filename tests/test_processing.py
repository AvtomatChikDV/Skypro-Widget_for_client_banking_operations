...
def test_filter_by_state(sample_dates) -> None:
...
def test_filter_by_state_no_list() -> None:
    """Функция проверки программы при отсутствии данных"""
    assert filter_by_state([], "EXECUTED") == []


def test_filter_by_state_other_(sample_dates) -> None:
...
def test_sort_by_date(operations) -> None:
    ...
    expected_dates = [
        "2023-03-01T10:00:00.000000",
        "2023-02-01T10:00:00.000000",
        "2023-02-01T10:00:00.000000",
        "2023-01-01T10:00:00.000000",
    ]
...
def test_sort_by_date_with_same_dates(operations) -> None:
...
def test_sort_by_date_single_element() -> None:
    ...
    assert sort_by_date([{"id": 1, "date": "2023-01-01T10:00:00.000000"}]) == [
        {"id": 1, "date": "2023-01-01T10:00:00.000000"}
    ]


def test_sort_by_date_missing_date_field() -> None:
